...
export const Spinner: React.FC<ISpinner> = ({width, height, margin}) => {
    return (
        <svg viewBox="0 0 100 100" style={{width: `${width}px`, height: `${height}px`, margin: `${margin}px`}}>
            ...
            <circle className="circle" cx="50" cy="50" r="30" fill="none"
                    style={{
                        animation: 'loader 8s ease infinite alternate, loader2 2s linear infinite',
                        stroke: 'url(#Gradient)',
                        strokeLinecap: 'round',
                        strokeWidth: '4',
                        strokeDasharray: '94.0955352783 94.0955352783',
                        strokeDashoffset: '0'
                    }}
            ></circle>
        </svg>
